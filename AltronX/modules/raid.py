    ...
    if e.sender_id in SUDO_USERS:
        ...
        if len(mkraid) == 2:
            ...
            if int(g) in ALTRON:
                ...
                await e.reply("» bhaii log ki jai ho", parse_mode=None, link_preview=None)
            else:
                c = a.first_name
    ...
    if e.sender_id in SUDO_USERS:
        ...
        if len(e.text) > 11:
            ...
            if int(user_id) in ALTRON:
                ...
                phucker = [user_id]
                gey.append(phucker)
                await e.reply("» Le ab Gaali kha, replyraid activated !! ✅", parse_mode=None, link_preview=None)
